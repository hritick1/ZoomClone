...
public class WelcomePagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        switch (position){
           case 1:
                return WelcomFragmentViewpager.newInstance(activity.getString(R.string.share_your_content),
                        activity.getString(R.string.they_see),R.drawable.welcome_2);

            case 2:
                return WelcomFragmentViewpager.newInstance(activity.getString(R.string.manage_your_team),
                        activity.getString(R.string.send_texts),R.drawable.welcome_3);

            case 3:
                return WelcomFragmentViewpager.newInstance(activity.getString(R.string.get_zooming),
                        activity.getString(R.string.work_anywhere),R.drawable.welcome_4);
            case 0:
            default:
                return WelcomFragmentViewpager.newInstance(activity.getString(R.string.start_a_meeting),
